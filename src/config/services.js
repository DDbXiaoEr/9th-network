 ...
 * 社团公共服务配置文件
 * ---------------------------------------------------------------
 * 日常只需要修改本文件即可调整「社团公共服务」板块，无需改动组件。
 * 开发模式下保存会自动热更新；发布前执行 `npm run build` 重新构建。
 *
 * 字段说明
 *   section     - 板块标题区的文案配置
 *   categories  - 服务分类（左侧筛选按钮，组件会自动在最前面加上 allLabel）
 *   services    - 服务项目列表，每项字段：
 *       id       唯一标识，可选，缺省时自动按顺序生成
 *       icon     图标名称，可选值见下方 ICON 清单
 *       title    服务名称
 *       category 所属分类，需与 categories 中的某项一致
 *       desc     服务简介
 *       tags     标签数组
...
export const servicesConfig = {
  section: {
    ...
    highlight: '公共服务',
    subtitle:
      '第九网络组面向全校师生提供技术类公共服务。以下项目长期开放，点击卡片可查看详情并申请。',
    allLabel: '全部',
    hint: '没有找到需要的服务？',
    hintAction: '联系我们定制支持'
  },
  ...
  services: [
    ...
    },
    {
      ...
      title: '网络故障诊断',
      category: '系统运维',
      desc: '校园网、宿舍网络连接异常排查，路由器配置优化，WiFi 信号与网速问题定位。',
      tags: ['路由配置', '故障排查'],
      status: '长期开放'
    },
    {
      ...
      title: '网络安全体检',
      category: '网络安全',
      desc: '账号安全、WiFi 安全、木马查杀与隐私防护建议，帮助你建立基本的网络安全意识。',
      tags: ['安全防护', '查杀'],
      status: '需预约',
      hot: true
    },
    {
      ...
      title: '网站与小程序开发',
      category: '开发支持',
      desc: '为校内社团、学生组织提供官网、活动报名页、小程序等轻量级开发与技术支持。',
      tags: ['Vue', '前端', '小程序'],
      status: '项目制',
      hot: true
    },
    {
      ...
      title: '软件安装与指导',
      category: '系统运维',
      desc: '办公、设计、编程等常用软件的正版获取与安装指导，解决环境配置与兼容性问题。',
      tags: ['办公', '开发环境'],
      status: '长期开放'
    },
    {
      ...
      title: '硬件维护与升级',
      category: '硬件服务',
      desc: '笔记本清灰、加装内存 / 固态硬盘、性能检测与升级建议，延长爱机使用寿命。',
      tags: ['清灰', '升级', '检测'],
      status: '需预约'
    },
    {
      ...
      title: '技术培训与讲座',
      category: '技术培训',
      desc: '定期举办计算机基础、网络技术、编程入门等公开课与分享会，零基础也能参与。',
      tags: ['公开课', '分享会'],
      status: '周期举办'
    },
    {
      ...
      title: '编程入门陪跑',
      category: '技术培训',
      desc: 'C / Python / 前端开发入门辅导，从环境搭建到第一个项目，学长学姐带你上手。',
      tags: ['C', 'Python', '前端'],
      status: '学期制'
    },
    {
      ...
      title: '数码选购咨询',
      category: '硬件服务',
      desc: '装机配置单、笔记本选购、外设搭配建议，按预算与专业需求给出中立推荐。',
      tags: ['装机', '选购'],
      status: '长期开放'
    },
    {
      ...
      title: '学科竞赛组队',
      category: '开发支持',
      desc: '为程序设计、网络安全、虚拟网络架构等竞赛提供组队、培训与指导支持。',
      tags: ['竞赛', '组队'],
      status: '赛期开放'
    },
    {
      ...
      title: '数据备份与恢复',
      category: '系统运维',
      desc: '重要文件备份方案建议、误删数据恢复尝试，帮你守住珍贵资料。',
      tags: ['备份', '恢复'],
      status: '需预约'
    },
    {
